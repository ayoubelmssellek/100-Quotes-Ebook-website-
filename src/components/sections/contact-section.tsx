      ...
      <div className="mx-auto grid max-w-[1280px] gap-12 px-6 lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-4 max-w-md text-lg leading-relaxed text-[var(--slate)]">
            Questions about your purchase, downloads, or upcoming titles? Send
          ...
          <div className="mt-8 rounded-lg border border-[var(--hairline)] bg-[var(--surface)] p-6 md:p-8">
            ...
            <p className="mt-3 text-base leading-relaxed text-[var(--charcoal)]">
              Please send your message to our support Gmail and we’ll get back
            ...
            <p className="mt-4 text-sm leading-relaxed text-[var(--slate)]">
              Include your order email and a short description of your question
        ...
        <div className="rounded-lg border border-[var(--hairline)] bg-[var(--canvas)] p-6 md:p-8">
          ...
          <p className="mb-6 text-sm leading-relaxed text-[var(--slate)]">
            Prefer a form? Fill this out — or email us directly at{" "}
            <a
              href={SUPPORT_MAILTO}
